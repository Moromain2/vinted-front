...
const OfferPage = () => {
    ...
    return isLoading ? ( // If the data has not yet been fetched
        <Loader />
        ...
        <div className="page-wrapper offer-page-wrapper">
            <div className="container">
                ...
                <div className="card product-info">
                    ...
                    <button onClick={() => {
                        navigate("/payment", {
                            // Setting state to be accessibles through useLocation() on the payment page
                            state: {
                                title: offer.product_name,
                                amount: offer.product_price
                            }
                        })
                    }} className="button button-fill">Acheter</button>
                </div>
            </div>
        </div>
    )
